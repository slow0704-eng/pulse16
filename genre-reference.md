...
> **2026-08-17 시점의 기록입니다 — 현행 문서 색인이 아닙니다.**
> 색인 역할은 [`README.md`](README.md) 가 맡습니다. 여기 있는 문서만 링크하던
> 시절의 글이라, 그때 없던 문서가 빠져 있습니다.
>
> 아래에서 **이미 사실이 아닌 것** 셋을 밝혀 둡니다.
> - 「`patterns/01`~`11` — 골격이 같은 장르는 한 블록에 묶어 표시」 → **2026-08-17 에
>   상속을 끊으면서 묶인 블록이 없어졌습니다.** 각 patterns 파일이 그렇게 적습니다.
> - 「다음에 할 것」의 Dubstep · Reggae One Drop · Funk → **셋 다 이미 프리셋이 있습니다.**
> - 신뢰도·커버리지 표의 수(손작성 56 / 파생 299 / `conventional` 237 / 프리셋 연결 358)
>   → **전부 그때의 값**입니다. 지금 수는 `node tools/build-refdata.mjs` 가 찍어 줍니다.
