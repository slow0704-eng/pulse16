...
/* ⚠ 원인을 단정하지 마세요. 예전 문구는 «미리보기 창이 차단했다» 고 단언했는데,
   실제로는 상류에 파일이 없어(404) 나는 실패가 섞여 있었습니다.
   사용자를 «파일을 내려받아 열어 보라» 는 쓸데없는 길로 보냈습니다. */
function blocked(){
  showWarn('외부 샘플(tonejs.github.io)을 받지 못했습니다. 네트워크·차단·상류 파일 없음 중 하나입니다 — '+
    '브라우저 개발자도구의 네트워크 탭에서 상태 코드를 보면 구분됩니다. '+
    '어느 쪽이든 **합성 엔진만으로 전 기능을 쓸 수 있습니다.**');
}
