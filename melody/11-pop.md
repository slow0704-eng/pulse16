...
(둘 다 4마디째 종지에서는 도수 1·0 으로 내려앉습니다).
...
([README.md](README.md) §4-1). B 계열이 가장 많이 갖습니다 —
긴 호흡이 어울리는 재료가 몰려 있기 때문입니다.

| 길이 | 키 |
|---|---|
| 32루프 | `pop_l32` · `bal_l32` · `ant_l32` · `cin_l32` · `chip_l32` · `dis_l32` |
| 64루프 | `pop_l64` · `bal_l64` · `ant_l64` · `cin_l64` |
