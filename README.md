...
프리셋 · 하위분기 · 음색 엔진 · 곡 형식 · 선율 · 리프 · 베이스 · 화성 · 컴핑 ·
필인을 **소스에서 직접 세어** 찍습니다. 이 수를 문서에 적지 마십시오 — 같은 수를
문서마다 다르게 적어 온 것이 이 저장소의 오래된 병이었습니다(엔진이 186 · 70 ·
222 로, 곡 형식이 13 · 18 로 갈려 있었습니다). 적는 대신 이 명령을 가리키십시오.
