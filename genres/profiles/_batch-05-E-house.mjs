...
export const groups = {
  piano: {
    ...
    mel: { density: [4, 6], leap: [0.20, 0.40], contour: 'arch', range: [4, 6], degrees: [0, 2, 4, 1], rhythm: 'onbeat', repetition: 'mid', voicing: 'chord' },
    ...
    pool: ['gos_aabb', 'dis_aabb', 'funk_aabb'],
  ...
  filter: {
    ...
    mel: { density: [5, 7], leap: [0.25, 0.45], contour: 'rise', range: [4, 7], degrees: [0, 2, 4, 5], rhythm: 'onbeat', repetition: 'high', voicing: 'chord' },
    ...
    chordType: 'sev', comping: 'disco_stab',
    pool: ['dis_abab', 'cin_aabb', 'edm_aabb'],
  ...
  deep: {
    ...
    mel: { density: [2, 4], leap: [0.15, 0.35], contour: 'static', range: [3, 5], degrees: [0, 2, 4], rhythm: 'offbeat', repetition: 'high', voicing: 'single' },
    bass: { role: 'root', oct: false, gate: 'long', kick: 'offset', glide: 'none' },
    lead: 'keys2', roles: { keys: 'pluck', keys2: 'pad', gtr: 'none', gtr2: 'none' },
    chordType: 'sev', comping: 'disco_stab',
    pool: ['amb_aaba', 'edm_aabb', 'bal_aaba'],
  ...
  garage: {
    ...
    mel: { density: [4, 6], leap: [0.25, 0.45], contour: 'zigzag', range: [4, 5], degrees: [0, 2, 1, 4, 3], rhythm: 'offbeat16', repetition: 'mid', voicing: 'single' },
  ...
  bigroom: {
    ...
    mel: { density: [6, 9], leap: [0.30, 0.50], contour: 'rise', range: [5, 7], degrees: [0, 2, 4, 7], rhythm: 'onbeat', repetition: 'low', voicing: 'single' },
  ...
  prog: {
    ...
    mel: { density: [6, 9], leap: [0.30, 0.50], contour: 'rise', range: [5, 7], degrees: [0, 2, 4, 7], rhythm: 'onbeat', repetition: 'mid', voicing: 'single' },
    bass: { role: 'root', oct: false, gate: 'short', kick: 'locked', glide: 'none' },
  ...
  acid: {
    ...
    mel: { density: [2, 4], leap: [0.15, 0.40], contour: 'static', range: [2, 4], degrees: [0, 2, 4], rhythm: 'offbeat', repetition: 'high', voicing: 'single' },
  ...
  tribal: {
    ...
    mel: { density: [4, 7], leap: [0.20, 0.45], contour: 'arch', range: [4, 6], degrees: [0, 2, 1, 4, 3], rhythm: 'offbeat16', repetition: 'mid', voicing: 'single' },
    ...
    chordType: 'sev', comping: 'disco_stab',
    pool: ['afr_aabb', 'lat_abab', 'edm_aabb'],
