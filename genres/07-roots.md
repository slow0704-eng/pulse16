...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Chicago Blues | `sub` | 24 | 120 | 0 | 40 | 34 | 110 | 3600 | 54 | 26 | 16 | Minor Pentatonic |
| ·Texas Blues | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 28 | Minor Pentatonic |
| ·Jump Blues | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 28 | Minor Pentatonic |
| ·Blues Rock | `reese` | 36 | 80 | 0 | 40 | 62 | 120 | 4000 | 56 | 32 | 22 | Minor Pentatonic |
| ·Country Blues | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 22 | Minor Pentatonic |
| ·Electric Blues | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 22 | Minor Pentatonic |
...
| 장르 | BPM | Swing | Kick | Snare | Clap | Hat | Tom | 튠 K/S/T/H |
|---|---|---|---|---|---|---|---|---|
| Honky-tonk | 130 | 0 | `wood` | `tight` | `tight` | `noise` | `wood` | 0/2/0/2 |
| Bluegrass | 150 | 0 | `wood` | `tight` | `tight` | `noise` | `wood` | 1/3/1/2 |
| ·Old-time / Hillbilly | 130 | 0 | `wood` | `body` | `tight` | `tick` | `wood` | -2/0/-2/0 |
...
| 장르 | 엔진 | Oct | Length | Glide | Blend | Drive | X-Over | Tone | Sub | Exc | Duck | Scale |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Honky-tonk | `sub` | 24 | 64 | 0 | 38 | 26 | 120 | 3800 | 48 | 24 | 14 | Major |
| Bluegrass | `sub` | 24 | 56 | 0 | 34 | 22 | 125 | 3600 | 46 | 22 | 12 | Major |
| ·Old-time / Hillbilly | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 22 | Minor Pentatonic |
| ·Nashville Sound | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 28 | Minor Pentatonic |
| ·Outlaw Country | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 28 | Minor Pentatonic |
| ·Country Pop | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 22 | Minor Pentatonic |
| ·Bro-country | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 28 | Minor Pentatonic |
| ·Countrypolitan | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 28 | Minor Pentatonic |
| ·Alt-country | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 28 | Minor Pentatonic |
| ·Americana | `sub` | 36 | 80 | 0 | 40 | 30 | 120 | 4000 | 56 | 32 | 22 | Minor Pentatonic |
...
| 장르 | 엔진 | Oct | Length | Glide | Blend | Drive | X-Over | Tone | Sub | Exc | Duck | Scale |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ·Folk Revival | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 22 | Minor Pentatonic |
| ·Indie Folk | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 22 | Minor Pentatonic |
| ·Folk Rock | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 28 | Minor Pentatonic |
...
| 장르 | 엔진 | Oct | Length | Glide | Blend | Drive | X-Over | Tone | Sub | Exc | Duck | Scale |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ·Gospel | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 28 | Major |
| ·Zydeco / Cajun | `sub` | 36 | 80 | 0 | 40 | 32 | 120 | 4000 | 56 | 32 | 28 | Minor Pentatonic |
